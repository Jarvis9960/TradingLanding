...
export default function IntelligenceSection() {
  return (
    <section className="relative z-10 overflow-hidden px-4 py-20 text-white md:px-8">
          ...
          <div className="space-y-10">
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {intelCards.map((card) => (
                <article
                  key={card.label}
                  className="group relative overflow-hidden rounded-[28px] border border-white/8 bg-gradient-to-br from-black/75 via-black/60 to-black/35 p-6 shadow-[0_18px_80px_rgba(3,3,12,0.55)] backdrop-blur-xl"
                >
